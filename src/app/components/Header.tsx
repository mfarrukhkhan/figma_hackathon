...
const Header = () => {
  ...
  <div className="w-[148px] h-[44px] absolute left-[60px] top-[40px] font-bold text-[32px] text-[#3563E9]">MORENT
  </div>
  <div className='w-[492px] h-[44px] absolute left-[272px] top-[40px] rounded-[70px] stroke-[#C3D4E9] border shadow-md'>
    ...
    <p className='text-[14px] font-medium absolute left-[60px] top-[-15px] text-nowrap opacity-[50%]'>Search something here</p>
    </div>
